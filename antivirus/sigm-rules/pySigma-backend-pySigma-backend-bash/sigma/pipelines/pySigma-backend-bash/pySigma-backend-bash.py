...
@Pipeline
def pySigma-backend-bash_pipeline() -> ProcessingPipeline:        # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"pySigma-backend-bash_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="pySigma-backend-bash_field_mapping",
